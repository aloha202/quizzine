...
UPDATE `page` SET `special_mark` = 'about' WHERE `page`.`id` = 2;

INSERT INTO `page` (`id`, `name`, `content`, `is_module_page`, `module_name`, `is_content_editable`, `special_mark`, `is_redirect`, `redirect_route`, `redirect_timeout`, `layout`, `is_visible_for_admin`, `slug`, `meta_title`, `meta_description`, `meta_keywords`) VALUES (NULL, 'Join us now!', 'Content', '0', NULL, '1', 'join', '0', '/', '5', NULL, '1', 'join', 'Join us now!', NULL, NULL);
INSERT INTO `email_template` (`id`, `name`, `subject`, `message`) VALUES (NULL, 'application_request_admin', 'New application request', 'Hey admin new aplication request');

CREATE TABLE application_request (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, channel VARCHAR(255), comment TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_backend_viewed TINYINT(1) DEFAULT '0', PRIMARY KEY(id)) ENGINE = INNODB;

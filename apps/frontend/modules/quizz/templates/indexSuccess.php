...
<div class="quizz">
	...
	<a href="<?php echo url_for('quizz_show', $Quizz); ?>" class="waves-effect waves-light btn yellow darken-2"><?php echo $Quizz->isPassed() ? __('Quizz is taken') : __('Take the quizz'); ?></a>
</div>

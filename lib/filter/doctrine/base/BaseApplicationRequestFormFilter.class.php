...
/**
 * ApplicationRequest filter form base class.
 *
 * @package    cms
 * @subpackage filter
 ...
 */
abstract class BaseApplicationRequestFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('application_request_filters[%s]');
